...
> Latent spatial memory training for long VIPE-labelled room tours is documented
> in [docs/zh/latent_spatial_memory_training.md](docs/zh/latent_spatial_memory_training.md).
