...
MODEL_DIR="${MODEL_DIR:-}"
PROMPT_JSON="${PROMPT_JSON:-assets/cases/ti2v/example_4/prompt.json}"
IMAGE="${IMAGE:-assets/cases/ti2v/example_4/first_frame.png}"
OUT_DIR="${OUT_DIR:-outputs/dense_ti2v_single_gpu_$(date +%Y%m%d_%H%M%S)}"
